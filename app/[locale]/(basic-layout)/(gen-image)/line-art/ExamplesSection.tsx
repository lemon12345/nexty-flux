...
export default function ExamplesSection() {
  const t = useTranslations("PhotoToLineArt.examples");

  const portraitExamples = [
    {
      id: 1,
      title: "Father Line Art 3",
      original: "/static/gallery/pexels-girl.jpg",
      result: "/static/gallery/pexels-girl-line.png"
    },
    {
      id: 2,
      title: "Father Line Art 7",
      original: "/static/gallery/pexels-girl1.jpg",
      result: "/static/gallery/pexels-girl1-art.png"
    },
    {
      id: 3,
      title: "Father Line Art",
      original: "/static/gallery/bird1_original_512.jpg",
      result: "/static/gallery/bird1_original_512.png"
    },
    {
      id: 4,
      title: "Father Line Art 2",
      original: "/static/gallery/wedding3_vintage_1024.webp",
      result: "/static/gallery/wedding3_vintage_1024.webp.png"
    },
    {
      id: 5,
      title: "Mother Line Art",
      original: "/static/gallery/mother1_original_512.webp",
      result: "/static/gallery/mother1_lineart_1024.png"
    },
    {
      id: 6,
      title: "Mother Line Art 2",
      original: "/static/gallery/mother2_original_512.webp",
      result: "/static/gallery/mother2_lineart_1024.png"
    },
    {
      id: 7,
      title: "Mother Line Art 4",
      original: "/static/gallery/mother4_original_512.webp",
      result: "/static/gallery/mother4_lineart_1024.png"
    },
    {
      id: 8,
      title: "Mother Line Art 6",
      original: "/static/gallery/mother6_original_512.webp",
      result: "/static/gallery/mother6_lineart_1024.png"
    }
  ];
