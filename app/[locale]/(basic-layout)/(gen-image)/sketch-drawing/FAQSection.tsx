...
export default function FAQSection() {
  const t = useTranslations("PhotoToPencilSketch.faq");
  const [openIndex, setOpenIndex] = useState<number | null>(null);

  const faqs = [
    {
      question: "Does the app create a generic pencil sketch drawing, or is it customized based on my photo?",
    ...
    },
    {
      ...
      answer: "PortraitArt offers a variety of art styles besides pencil sketch, including oil painting, watercolor, illustration, colored line art, line sketch, 3D and 2D cartoons, pop art, caricature, coloring pages, sculpture, Chinese ink, and more."
    },
    {
