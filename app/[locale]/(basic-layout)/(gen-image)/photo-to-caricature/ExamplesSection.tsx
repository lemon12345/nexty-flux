...
export default function ExamplesSection() {
  const t = useTranslations("PhotoToCaricature.examples");

  const portraitExamples = [
    {
      id: 1,
      title: "Girl Caricature",
      original: "/static/gallery/girl2_original_512.jpg",
      result: "/static/gallery/girl2_caricature_1024.png"
    },
    {
      id: 2,
      title: "Wedding Caricature",
      original: "/static/gallery/wedding8_original_512.jpg",
      result: "/static/gallery/wedding8_caricature_1024.png"
    },
    {
      id: 3,
      title: "Children Caricature",
      original: "/static/gallery/children1_original_512.webp",
      result: "/static/gallery/children1_caricature_1024.png"
    },
    {
      id: 4,
      title: "Girl Caricature 2",
      original: "/static/gallery/girl8_original_512.webp",
      result: "/static/gallery/girl8_caricature_1024.png"
    },
    {
      id: 5,
      title: "Girl Caricature 3",
      original: "/static/gallery/girl1_original_512.webp",
      result: "/static/gallery/girl1_caricature_1024.png"
    },
    {
      id: 6,
      title: "Old Photo Caricature",
      original: "/static/gallery/oldphoto1_original_512.webp",
      result: "/static/gallery/oldphoto1_caricature_1024.png"
    },
    {
      id: 7,
      title: "Mother Caricature",
      original: "/static/gallery/mother4_original_512.webp",
      result: "/static/gallery/mother4_caricature_1024.png"
    },
    {
      id: 8,
      title: "Mother Caricature 2",
      original: "/static/gallery/bird1_original_512.jpg",
      result: "/static/gallery/bird1-caricature.png"
    }
  ];
