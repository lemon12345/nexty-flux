...
export default function FAQSection() {
  const t = useTranslations("PhotoToSculpture.faq");
  const [openIndex, setOpenIndex] = useState<number | null>(null);

  const faqs = [
    {
      question: "Does the app create a customized sculpture picture based on my photo?",
    ...
    },
    {
      ...
      answer: "PortraitArt offers a variety of art styles besides sculpture, including classical oil painting, watercolor, illustration, colored line art, pencil sketch, line sketch, 3D and 2D cartoons, pop art, caricature, coloring pages, Chinese ink, and more."
    },
    {
