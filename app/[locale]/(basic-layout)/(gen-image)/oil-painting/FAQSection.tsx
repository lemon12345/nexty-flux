...
export default function FAQSection() {
  const t = useTranslations("PhotoToOilPainting.faq");
  const [openIndex, setOpenIndex] = useState<number | null>(null);

  const faqs = [
    {
      question: "Does the app create a generic oil painting, or is it customized based on my photo?",
    ...
    },
    {
      ...
      answer: "PortraitArt offers a variety of art styles besides oil painting, including watercolor, illustration, colored line art, pencil sketch, line sketch, 3D and 2D cartoons, pop art, caricature, coloring pages, sculpture, Chinese ink, and more."
    },
    {
