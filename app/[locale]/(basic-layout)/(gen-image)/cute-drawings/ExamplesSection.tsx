...
export default function ExamplesSection() {
  const t = useTranslations("PhotoToCartoonDrawing.examples");

  const portraitExamples = [
    {
      id: 1,
      title: "Mother and Daughter Cartoon",
      original: "/static/gallery/mother7_original_512.jpg",
      result: "/static/gallery/mother7_cartoon_drawing_1024.png"
    },
    {
      id: 2,
      title: "Wedding Couple Cartoon",
      original: "/static/gallery/wedding8_original_512.jpg",
      result: "/static/gallery/wedding8_cartoon_drawing_1024.png"
    },
    {
      id: 3,
      title: "Couple Cartoon",
      original: "/static/gallery/couple_original_512.jpg",
      result: "/static/gallery/couple_cartoon_drawing_1024.png"
    },
    {
      id: 4,
      title: "Basketball Player Cartoon",
      original: "/static/gallery/basketball1_original_512.webp",
      result: "/static/gallery/basketball1_cartoondrawing_1024.png"
    },
    {
      id: 5,
      title: "Bird Cartoon",
      original: "/static/gallery/bird1_original_512.webp",
      result: "/static/gallery/bird1_cartoondrawing_1024.png"
    },
    {
      id: 6,
      title: "Family Father Cartoon",
      original: "/static/gallery/family3_father_original_512.webp",
      result: "/static/gallery/family3_father_cartoondrawing_1024.png"
    },
    {
      id: 7,
      title: "Father Portrait Cartoon",
      original: "/static/gallery/father1_original_512.webp",
      result: "/static/gallery/father1_cartoondrawing_1024.png"
    },
    {
      id: 8,
      title: "Father Portrait 2 Cartoon",
      original: "/static/gallery/father3_original_512.webp",
      result: "/static/gallery/father3_cartoondrawing_1024.png"
    },
    {
      id: 9,
      title: "Father Portrait 3 Cartoon",
      original: "/static/gallery/father7_original_512.webp",
      result: "/static/gallery/father7_cartoondrawing_1024.webp"
    },
    {
      id: 10,
      title: "Mother Portrait Cartoon",
      original: "/static/gallery/mother1_original_512.webp",
      result: "/static/gallery/mother1_cartoondrawing_1024.webp"
    }
  ];
