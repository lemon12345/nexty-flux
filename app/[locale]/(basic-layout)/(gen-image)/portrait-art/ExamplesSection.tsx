...
export default function ExamplesSection() {
  const t = useTranslations("PhotoToPopArt.examples");

  const portraitExamples = [
    {
      id: 1,
      title: "Father 7 Portrait Art",
      original: "/static/gallery/solution-before.webp",
      result: "/static/gallery/solution-portrait.png"
    },
    {
      id: 2,
      title: "Graduation 1 Portrait Art",
      original: "/static/gallery/solution-portrait1.jpg",
      result: "/static/gallery/solution-portrait2.png"
    },
    {
      id: 3,
      title: "Father 6 Old Photo Portrait Art",
      original: "/static/gallery/pexels-creationhill-1681010.jpg",
      result: "/static/gallery/pexels-creationhill-1681011.png"
    },
    {
      id: 4,
      title: "Dog 7 Portrait Art",
      original: "/static/gallery/pexels-thgusstavo-1933873.jpg",
      result: "/static/gallery/pexels-thgusstavo-1933874.png"
    },
    {
      id: 5,
      title: "Children 1 Portrait Art",
      original: "/static/gallery/pexels-olly-3768117.jpg",
      result: "/static/gallery/pexels-olly-3768118.png"
    },
    {
      id: 6,
      title: "Couple 1 Pop Art",
      original: "/static/gallery/pexels-himeshmehtaa25-3104719.jpg",
      result: "/static/gallery/professional-headshot-1757150543917-sga3be.png"
    }
  ];
